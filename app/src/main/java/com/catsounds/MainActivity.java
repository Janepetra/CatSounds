...
public class MainActivity extends AppCompatActivity {
    ...
    private void playSound(int arg){
        ...
        if (arg == 1) {
            player = MediaPlayer.create(this, R.raw.meow1);
        }
        if (arg == 2) {
            player = MediaPlayer.create(this, R.raw.meow2);
        }
        if (arg == 3) {
            player = MediaPlayer.create(this, R.raw.meow3);
        }
        if (arg == 4) {
            player = MediaPlayer.create(this, R.raw.meow4);
        }
        if (arg == 5) {
            player = MediaPlayer.create(this, R.raw.meow5);
        }
        if (arg == 6) {
            player = MediaPlayer.create(this, R.raw.meow6);
        }
        if (arg == 7) {
            player = MediaPlayer.create(this, R.raw.meow7);
        }
        if (arg == 8) {
            player = MediaPlayer.create(this, R.raw.meow8);
        }
